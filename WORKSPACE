...
# Download the rules_docker repository at release 0.15.0
http_archive(
...
go_repository(
    ...
    sum = "h1:+EffdPis0tag7c/GuHRUsfM2kagBqzFJ5wcWPsGLgzE=",
    version = "v0.2.1",
)
...
go_repository(
    ...
    sum = "h1:OKbAoGs4fGM5cPLlVQLZGYkFC8OnOfgo6tt0Smf9XhM=",
    version = "v0.0.0-20200511232937-7e40ca221e25",
)
...
go_repository(
    ...
    sum = "h1:IEBpNzW/9/NU5bE2U/ugfEXT/hzRWLKS+5ItQvPlTyY=",
    version = "v1.11.0",
)
...
go_repository(
    ...
    sum = "h1:S73+nz2/3EbJLIJ3S4mUgylzvl9TFCddfEDEWF2an/Y=",
    version = "v0.0.0-20200501175525-0ca4b022b9f0",
)
